...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>Cake Zest | HOME</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <!--CSS File-->
        <link rel="stylesheet" type="text/css" href="Common.css">
        <link rel="stylesheet" type="text/css" href="Deepak.css">
        <!-- Font Awesome -->
        ...
        <!-- COUNTDOWN FUNCTION JAVASCRIPT BY Mithra -->
        ...
        <div class="what-you-can-do">
            ...
            <div class="row">
                ...
                <div class="column">
                    ...
                    <span class="what-you-can-do-subtitle buy-our-cake">Freshly bak
                    <i class="fas fa-mitten"  style="color: black;"></i>
                    <span class="what-you-can-do-subtitle customize-cake">Cused cakes</span>
                    <span class="what-you-can-do-text">Get a taste of our freshly prepared cakes by ordering online!</span>
                </div>

                <div class="column">tomize your cake</span>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper0">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Person-1</b></p>
                            <p class="hierarchy">CEO - Cake Zest Bakery Shop</p>
